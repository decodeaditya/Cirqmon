...
const Canvas = ({ circuit, setCircuit, removeGate }) => {
    return (
        <>
            <div className={`h-[90%] min-w-[60%] overflow-y-auto relative scrollbar-none bg-white/20 backdrop-blur-3xl z-100  rounded-4xl transition-all shadow-[0px_2px_4px_0px_rgba(14,30,37,0.12),0px_2px_16px_0px_rgba(14,30,37,0.32)]`}>
