...
const pikachu = <svg
    ...
    height={100}
    className="
          absolute top-[-100%] right-[42%]
          transition-all duration-500
          animate-[tilt_1.1s_infinite_ease-in-out]
          group-hover:top-[10%] group-hover:left-[-40%]
        "
>
    <path
        strokeWidth="2.808"
...
const ball = <svg
    ...
    width={32}
    height={32}
    className="absolute top-[20%] left-[10%] animate-spin group-hover:animate-none group-hover:scale-0 transition-transform"
>
    <path
        stroke="#000"
        fill="#fe0505"
...
const PokemonBtn = () => {
    return (
        <button
            className="
        relative w-[150px] h-[60px] overflow-hidden
        border-2 border-black rounded-[50px] pl-[35px] cursor-pointer bg-white
        shadow-lg
        group hover:shadow-2xl hover:scale-[1.05] transition-transform
      "
        >
            {pikachu}

            <span className="absolute top-[10%] left-[45%] text-[30px] font-black codePart tracking-[1px] group-hover:text-transparent transition-colors">
                GO!
            </span>

            {ball}
            <span className="absolute top-[30%] left-[72%] text-[13px] opacity-0 animate-[pulse-animation_0011_1s_infinite] group-hover:opacity-100">
                make
            </span>
            <span className="absolute top-[55%] left-[75%] text-[13px] opacity-0 animate-[pulse-animation_0011_1s_infinite] group-hover:opacity-100">
                make
            </span>
        </button>
    );
